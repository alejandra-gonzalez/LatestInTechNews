...
final public class QueryUtils {
    ...
    /**
     * Makes an HTTP request for the specified URL and returns data from API response.
     */
    ...
    /**
     * Makes an HTTP request to the given URL and return server response as String.
     */
    ...
    /**
     * Converts InputStream into a String which contains the whole JSON response from the server.
     */
